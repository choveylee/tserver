module github.com/choveylee/tserver

go 1.25.0

require (
	github.com/choveylee/tlimiter v0.0.0-20260412135354-dab2790235eb
...
require (
	...
	github.com/choveylee/ttrace v0.0.0-20260412131731-ea637294fd05 // indirect
